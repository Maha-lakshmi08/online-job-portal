        ...
        <div className='px-5 flex justify-between items-center'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div className='relative group'>
              <img className='w-8 border rounded-full' scr={assets.company_icon}  alt="" />
              <div className='absolute hidden group-hover:block top-0 right-0 x-20 text-black rounded pt-12'>
